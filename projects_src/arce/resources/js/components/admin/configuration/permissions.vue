	...
	export default {
		...
		methods:{
			getPermissions:function(){
				axios.get(tools.url("/api/admin/permissions")).then((response)=>{
			...
			savePermission:function(e){
				...
				this.$parent.validateAll(()=>{
					axios.post(tools.url("/api/admin/role/"+this.id),this.role).then((response)=>{
			...
			deleteRole:function(){
				alertify.confirm("¿Seguro que deseas borrar este rol?",()=>{
					axios.delete(tools.url("/api/admin/role/"+this.id)).then((response)=>{
			...
			getRole:function(){
				axios.get(tools.url("/api/admin/role/"+this.id)).then((response)=>{
