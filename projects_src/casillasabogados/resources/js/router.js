...
//Titulos del website
import VueDocumentTitlePlugin from "vue-document-title-plugin";8
Vue.use(VueDocumentTitlePlugin, MyRouter,
	{ defTitle: "Casillas Abogados Penalistas", filter: (title)=>{ return title+" - Casillas Abogados Penalistas"; } }
);
